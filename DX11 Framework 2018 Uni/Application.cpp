...
void Application::Draw()
{
	...
	meshManager[0]->GenerateMesh(_pd3dDevice, _pVertexBuffer, _pIndexBuffer, _pImmediateContext, cb);

	meshManager[0]->Draw(_pVertexShader, _pPixelShader, _pConstantBuffer);
