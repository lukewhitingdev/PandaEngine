...
void sphere::Draw(ID3D11DeviceContext* context, ID3D11PixelShader* pixelShader, ID3D11Buffer* constantBuffer, ConstantBuffer& cb)
{
...
void sphere::Update(float time, float x, float y, float z)
{
