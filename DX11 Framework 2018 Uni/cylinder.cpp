...
void cylinder::Draw(ID3D11DeviceContext* context, ID3D11PixelShader* pixelShader, ID3D11Buffer* constantBuffer, ConstantBuffer& cb)
{
...
void cylinder::Update(float time, float x, float y, float z, float scale)
{
